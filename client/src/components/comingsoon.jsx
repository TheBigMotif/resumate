        ...
        */}
        <div className="flex flex-col min-h-screen bg-slate-100 justify-center items-center">
          <main className="max-w-lg px-6 py-24 sm:py-32 sm:px-8">
            ...
            <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">New features coming soon!</h1>
        ...
        <ul className="flex flex-wrap">
          ...
          <li>
            ...
            >
              <svg className="w-auto h-4 mr-2 fill-current text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
